...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.RankMasterAccount = field.NewString(tableName, "rank_master_account")
	_user.Password = field.NewString(tableName, "password")
	_user.Avatar = field.NewString(tableName, "avatar")
	_user.Mobile = field.NewString(tableName, "mobile")
	_user.CryptSalt = field.NewString(tableName, "crypt_salt")
...
func (u *user) updateTableName(table string) *user {
	...
	u.RankMasterAccount = field.NewString(table, "rank_master_account")
	u.Password = field.NewString(table, "password")
	u.Avatar = field.NewString(table, "avatar")
	u.Mobile = field.NewString(table, "mobile")
	u.CryptSalt = field.NewString(table, "crypt_salt")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["rank_master_account"] = u.RankMasterAccount
	u.fieldMap["password"] = u.Password
	u.fieldMap["avatar"] = u.Avatar
	u.fieldMap["mobile"] = u.Mobile
	u.fieldMap["crypt_salt"] = u.CryptSalt
}
